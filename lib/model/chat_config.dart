Map<String, String> chatConfig = {
  "hi":
      "Hello! Welcome to Pet Buddy App! How can I assist?",
  "thank you":
      "BuddyBot is glad to help you!",
  "thanks":
      "BuddyBot is glad to help you!",
  "salamat":
      "BuddyBot is glad to help you!",
  ...
  "opening time":
      "The clinic operates starting from 9 AM to 5 PM.",
  "closing time":
      "The clinic is open until 5 PM.",
  "open":
      "The clinic operates starting from 9 AM to 5 PM.",
  "close":
      "The clinic is open until 5 PM.",
